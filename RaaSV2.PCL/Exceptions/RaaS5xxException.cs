...
{
    public class RaaS5xxException : APIException 
    {
        ...
        private List<Models.RaaS5xxErrorModel> errors;
        ...
        /// </summary>
        [JsonProperty("errors")]
        public List<Models.RaaS5xxErrorModel> Errors 
        { 
            get 
            {
                return this.errors; 
        ...
        public RaaS5xxException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
    }
