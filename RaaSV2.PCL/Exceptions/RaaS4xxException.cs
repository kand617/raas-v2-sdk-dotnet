...
{
    public class RaaS4xxException : APIException 
    {
        ...
        private List<Models.RaaS4xxErrorModel> errors;
        ...
        /// </summary>
        [JsonProperty("errors")]
        public List<Models.RaaS4xxErrorModel> Errors 
        { 
            get 
            {
                return this.errors; 
        ...
        public RaaS4xxException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
    }
